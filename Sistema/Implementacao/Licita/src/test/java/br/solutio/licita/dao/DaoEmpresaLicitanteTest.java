...
public class DaoEmpresaLicitanteTest {
    ...
    private DAOTestes<PessoaJuridica> daoEmpresaLicitante;
    ...
    public void testeSalvar(){
        ...
        daoEmpresaLicitante.criar(empresaLicitante.getPessoaJuridica());
        ...
        assertEquals(true ,empresaLicitanteAux.getId() == 2);
    }
...
//        daoEmpresaLicitante.deletar(empresaLicitante.getPessoaJuridica());
        daoEmpresaLicitante.deletar(empresaLicitanteAux.getPessoaJuridica());
//        assertEquals(true, empresaLicitante.getPessoaJuridica().getId() == null);
//        assertEquals(true, empresaLicitante.getId() == 0);
        assertEquals(true, empresaLicitanteAux.getId() == 0);
        assertEquals(true, empresaLicitanteAux.getPessoaJuridica().getId() == null);
    }
